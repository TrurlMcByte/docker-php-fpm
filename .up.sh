...
#    ssh -tA root@front$f docker stop php-fpm-goha
#    ssh -tA root@front$f docker rm php-fpm-goha
#    ssh -tA root@front$f docker rmi trurl/php-goha
